...
v0.5.8 — личный проект, активная разработка, API может меняться.
...
меняйте, делитесь. IT-Deck остаётся бесплатным, платной версии нет.
Коммерческое использование — только по договорённости с автором:
[напишите мне](https://github.com/Itegin).
